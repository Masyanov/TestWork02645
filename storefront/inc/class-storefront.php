...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
            ...
            wp_enqueue_script( 'storefront-jquery', get_template_directory_uri() . '/assets/js/jquery' . $suffix . '.js', array(), $storefront_version, true );
            ...
            wp_enqueue_script( 'storefront-search', get_template_directory_uri() . '/assets/js/search.js', array(), $storefront_version, true );
